        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(options =>
            {
                options.SwaggerDoc("v1", new Microsoft.OpenApi.Models.OpenApiInfo()
                {
                    ...
                    Version = "v1",
                    Description = "ProductCatalog API Test"
                });
            });
            services.AddTransient<IBookItemBO, BookItemBO>();
            services.AddTransient<IBookRepository>(x => new BookRepository(false, x.GetRequiredService<ProductCatalogContext>()));
        }
